        ...
        componentDidMount() {
          this.scrollToHash(),
            n.isSsr &&
              (a.isFallback ||
                (a.nextExport &&
                  (E.isDynamicRoute(n.pathname) || location.search || Z)) ||
              ...
              n
                .replace(
                  n.pathname +
                    ...
                    String(
                      x.assign(
                        x.urlQueryToSearchParams(n.query),
          ...
          i
            ...
            .then((r) => {
              ...
              return Promise.resolve(
                ...
                ea(y({}, e, { err: l, Component: s, styleSheets: u, props: t }))
              )
            })
        )
      }
        ...
        return (
          !(function (e, t) {
            ...
            if (J) {
              ...
              (J = P.default.hydrateRoot(e, r, {
                onRecoverableError(e) {
                  if (e.message !== F.NEXT_DYNAMIC_NO_SSR_CODE) throw e
                },
              })),
                (Q = !1)
          })(l, (e) => _.default.createElement(en, { callbacks: [e, h] }, m)),
          p
        )
      }
      function eo(e) {
                ...
                if (
                  ...
                  let h = S.parsePath(e),
                    m = M.formatNextPathnameInfo(
                      a(
                        {},
                        R.getNextPathnameInfo(h.pathname, {
                          nextConfig: n,
                          parseData: !0,
                        }),
          ...
          p = (e) =>
            (function e(t, r, n) {
              ...
              .catch((e) => {
                throw (
                  (d || delete n[f],
                  'Failed to fetch' === e.message && u.markAssetError(e),
                  e)
                )
              })
        return d && s
          ...
          return n(function* () {
            ...
            if (!p && l.onlyAHashChange(U) && !W) {
              ...
              try {
                ...
                throw (
                  (d.default(Z) &&
                    Z.cancelled &&
                    J.events.emit('routeChangeError', Z, U, k),
                  Z)
                )
              }
            ...
            let Q = s.removeTrailingSlash(V),
              ...
              et = !!(
                ...
                Q !== ee &&
                (!g.isDynamicRoute(Q) ||
                  !_.getRouteMatcher(P.getRouteRegex(Q))(ee))
              ),
              er =
                !o.shallow &&
            ...
            if (
              ...
              h &&
                ...
                G.pathname === V ||
                  ...
                  er || (t = b.formatWithValidation(G)))),
              !B(r))
            )
              return $({ url: r, router: l }), !1
            ;(K = E.removeLocale(x.removeBasePath(K), v.locale)),
              (Q = s.removeTrailingSlash(V))
            let en = !1
            if (g.isDynamicRoute(Q)) {
              ...
              if (en && (!el || es.result))
                ...
                let eu = Object.keys(ei.groups).filter(
                  (e) => !X[e] && !ei.groups[e].optional
                )
                if (eu.length > 0 && !er)
                  throw Error(
                    (el
            ...
            try {
              ...
              if ('route' in ev && er) {
                ;(Q = V = ev.route || Q),
                  k.shallow || (X = Object.assign({}, ev.query || {}, X))
                let e_ = j.hasBasePath(G.pathname)
                ...
                if (
                  ...
                  let eS = P.getRouteRegex(V),
                    ew = _.getRouteMatcher(eS)(
                      new URL(eb, location.href).pathname
                    )
              ...
              if ('type' in ev) {
                if ('redirect-internal' === ev.type)
                  return l.change(e, ev.newUrl, ev.newAs, o)
                return (
                  $({ url: ev.destination, router: l }), new Promise(() => {})
                )
              }
              let eE = ev.Component
              ...
              if ((ev.__N_SSG || ev.__N_SSP) && ev.props) {
                if (ev.props.pageProps && ev.props.pageProps.__N_REDIRECT) {
                  ...
                  if (
                    eC.startsWith('/') &&
                    !1 !== ev.props.pageProps.__N_REDIRECT_BASE_PATH
                  ) {
                ...
                if (
                  ((v.isPreview = !!ev.props.__N_PREVIEW),
                  ev.props.notFound === z)
                ) {
                  let eM
                  try {
              ...
              p &&
                '/_error' === l.pathname &&
                (null == (ec = self.__NEXT_DATA__.props)
                  ? void 0
                  : null == (ed = ec.pageProps)
                  ? void 0
                  : ed.statusCode) === 500 &&
                (null == (ef = ev.props) ? void 0 : ef.pageProps) &&
                (ev.props.pageProps.statusCode = 500)
              let eL =
                  o.shallow && v.route === (null != (ep = ev.route) ? ep : Q),
              ...
              if (p && ('/404' === l.pathname || '/_error' === l.pathname)) {
                ...
                try {
                  ...
                  throw (
                    (d.default(ek) &&
                      ek.cancelled &&
                      J.events.emit('routeChangeError', ek, U, k),
                    ek)
                  )
                }
                return !0
              ...
              let eD =
                p && !eI && !O && !W && A.compareRouterStates(eN, l.state)
              if (!eD) {
                try {
                  yield l.set(eN, ev, eI)
                } catch (eB) {
                ...
                if (ev.error)
                  throw (
                    (p || J.events.emit('routeChangeError', ev.error, U, k),
                    ev.error)
                  )
                p || J.events.emit('routeChangeComplete', r, k),
                  eT && /#.+$/.test(r) && l.scrollToHash(r)
              }
              return !0
            } catch (eH) {
          ...
          return n(function* () {
            ...
            try {
              ...
              if (
                (g &&
                  (M
                    ? (M.json = self.__NEXT_DATA__.props)
                    : (M = { json: self.__NEXT_DATA__.props })),
                E(),
                (null == M
                  ? void 0
              ...
              if (
                ...
                if (
                  ...
                  (l = x.removeBasePath(
                    p.normalizeLocalePath(M.effect.parsedAs.pathname, v.locales)
                      .pathname
                  )),
                  (C = v.components[e]),
              ...
              let { props: k, cacheKey: D } = yield v._getData(
                n(function* () {
                  if (N) {
                    if ((null == M ? void 0 : M.json) && !I)
                      return { cacheKey: M.cacheKey, props: M.json }
                    let e = (null == M ? void 0 : M.dataHref)
                        ? M.dataHref
